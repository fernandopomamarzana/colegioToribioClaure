...
export class PreviewImagePage implements OnInit {
  ...
  public image:any;
  public boletin_info:Array<any>=[];
  public indice:number;
  constructor(
    public navParam:NavParams,
    public modalCtrl:ModalController
  ) { 
    this.boletin_info=navParam.get('images');
    this.indice=navParam.get('indice');
    this.image=this.boletin_info[this.indice].urlImage;
  }

  ngOnInit() {
    //this.slide.slideTo(this.indice);
    //this.slideOpts.initialSlide=this.indice;
  }
  close()
  {
